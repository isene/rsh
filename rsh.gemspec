Gem::Specification.new do |s|
  ...
  s.description = "A shell written in Ruby with extensive tab completions, aliases/nicks, history, syntax highlighting, theming, auto-cd, auto-opening files and more. UPDATE v3.4.8: Code refactoring with DRY helpers (ensure_type, persist_var), nick/gnick feedback messages, fixed @plugin_enabled bug. Cleaner, more maintainable codebase!"
